...
<div class="container">
	<form action="/blog/user?cmd=joinProc" method="POST" class="was-validated" onsubmit="return validate()">
		...
		<div class="form-group">
			<label for="username">Username:</label> <input type="button" class="btn btn-warning float-right" onClick="usernamecheck();" value="중복확인" /> <input type="text" class="form-control" id="username"
